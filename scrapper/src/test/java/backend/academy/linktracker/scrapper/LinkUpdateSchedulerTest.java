...
class LinkUpdateSchedulerTest {
    ...
    void schedulerProcessesLinksInBatches() {
        ...
        LinkUpdateScheduler scheduler = new LinkUpdateScheduler(
                repository,
                List.of(new StubLinkSourceClient(Instant.parse("2026-01-01T00:00:00Z"))),
                notificationSender,
                properties);
    ...
    void schedulerIsolatesErrorsForBrokenLinkAndContinues() {
        ...
        SchedulerProperties properties = new SchedulerProperties();
        LinkUpdateScheduler scheduler = new LinkUpdateScheduler(
                repository, List.of(new SelectiveFailClient(broken)), notificationSender, properties);
    ...
    void schedulerUsesParallelProcessingWhenParallelismConfigured() {
        ...
        LinkUpdateScheduler scheduler =
                new LinkUpdateScheduler(repository, List.of(client), notificationSender, properties);
    ...
    private static final class SelectiveFailClient implements LinkSourceClient {
        ...
        public Optional<LinkSourceUpdate> fetchUpdate(URI uri) {
            ...
            return Optional.of(new LinkSourceUpdate(
                    updates.computeIfAbsent(uri, key -> Instant.parse("2026-01-01T00:00:00Z")), "ok"));
        }
    }
